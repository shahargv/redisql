...
AUTHORIZATION [dbo]
FROM 'C:\Projects\RediSQLCache\RediSql\bin\Debug\RediSql.dll'
...
RETURNS bit
AS EXTERNAL NAME [RediSql].[RediSql.Sql.Functions.RedisSqlFunctions].[IsKeyExists]
GO
...
AS EXTERNAL NAME [RediSql].[RediSql.Sql.Functions.RedisSqlFunctions].[SetStringValue]
GO
...
AS EXTERNAL NAME [RediSql].[RediSql.Sql.Functions.RedisSqlFunctions].[GetStringValue]
...
RETURNS nvarchar(max)
AS EXTERNAL NAME [RediSql].[RediSql.Sql.Functions.RedisSqlFunctions].[GetSetStringValue]
GO
...
RETURNS bit
AS EXTERNAL NAME [RediSql].[RediSql.Sql.Functions.RedisSqlFunctions].[DeleteKey]
GO
...
RETURNS bit
AS EXTERNAL NAME [RediSql].[RediSql.Sql.Functions.RedisSqlFunctions].[SetStringValueIfNotExists]
GO
...
RETURNS bit
AS EXTERNAL NAME [RediSql].[RediSql.Sql.Functions.RedisSqlFunctions].[Rename]
GO
...
RETURNS bit
AS EXTERNAL NAME [RediSql].[RediSql.Sql.Functions.RedisSqlFunctions].[SetRelativeExpiration]
GO
...
RETURNS bit
AS EXTERNAL NAME [RediSql].[RediSql.Sql.Functions.RedisSqlFunctions].[SetExactExpiration]
GO
...
RETURNS int
AS EXTERNAL NAME [RediSql].[RediSql.Sql.Functions.RedisSqlFunctions].[GetKeyTTL]
GO
...
AS EXTERNAL NAME [RediSql].[RediSql.Sql.Functions.RedisSqlFunctions].[Save]
GO

CREATE PROCEDURE redisql.Flush(@host nvarchar(250), @port int = 6379, @password nvarchar(100) = null, @dbId int = null)
AS EXTERNAL NAME [RediSql].[RediSql.Sql.Functions.RedisSqlFunctions].[Flush]
GO

CREATE FUNCTION redisql.GetLastSaved(@host nvarchar(250), @port int = 6379, @password nvarchar(100) = null, @dbId int = null)
RETURNS datetime
AS EXTERNAL NAME [RediSql].[RediSql.Sql.Functions.RedisSqlFunctions].[GetLastSaved]
GO
...
AS EXTERNAL NAME [RediSql].[RediSql.Sql.Functions.RedisSqlFunctions].[GetKeys]
GO
...
AS EXTERNAL NAME [RediSql].[RediSql.Sql.Functions.RedisSqlFunctions].[GetInfo]
GO
